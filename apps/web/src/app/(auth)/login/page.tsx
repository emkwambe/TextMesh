  ...
  return (
    <div>
      ...
      <p className="text-neutral-600 dark:text-neutral-400 mb-8">
        Sign in to continue to TextMesh
      </p>
      ...
      <div className="grid grid-cols-2 gap-4">
        <Button variant="secondary" size="lg" onClick={() => toast('Google sign-in coming soon!')}>
        ...
        <Button variant="secondary" size="lg" onClick={() => toast('Apple sign-in coming soon!')}>
